...
float scrollUpOrDown = 0;
float moveUpOrDown = 0;
float moveLeftOrRight = 0;

bool isLeftClickPressed = false;
bool isFirstLeftClickMovement = true;

bool isRightClickPressed = false;
bool isFirstRightClickMovement = true;

double previousLeftMouseX = 0;
double previousLeftMouseY = 0;
double previousRightMouseX = 0;
double previousRightMouseY = 0;
